...
const Agregarrapido: FC<Props> = ({ open, onClose, onAdd }) => {
  ...
  const agregar = () => {
    ...
    // Evitamos agregar registros totalmente vacíos
        ...
        <div className="px-8 py-6">
          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-200 px-3 py-2 text-sm bg-[#F9FAFF]"
                placeholder="ejemplo@itsp.edu.mx"
              />
            </div>
          </div>
          ...
          <div className="mt-6 flex items-center justify-end gap-3">
            ...
            <button
              type="button"
              onClick={agregar}
              className="px-6 py-2.5 rounded-xl bg-[#3A82F6] text-white text-sm font-semibold"
            >
              Agregar
            </button>
          </div>
